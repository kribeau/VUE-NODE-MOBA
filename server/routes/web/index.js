module.exports = app => {
  ...
  router.get('/news/init', async (req, res) => {
    ...
    const cats = await Category.find()
      ...
      .lean()
    const newsTitles = [
      '王者 X Meco丨你收到一封来自峡谷的甜Me情书',
      '新皮肤爆料丨穿上这件免费的衣服，你就是“队”的人！',
      '夏日盛典丨孙膑2.0改造进度曝光，小乔星元免费拿！',
      '新皮肤爆料丨大秦宣太后优化进度曝光，玩趣恶龙惊现峡谷~',
      '星元皮肤爆料 | 小乔百变泳装，测测你最适合哪一款！',
      '7月12日全服不停机更新公告',
      '【稷下星之队】建议更新版本上架公告',
      '心愿单升级完毕 104个小区开放功能体验',
      '云霓雀翎皮肤音效及模型异常说明公告',
      '【正式服】“稷下星之队”版本异常问题说明',
      '王者 X Meco丨你收到一封来自峡谷的甜Me情书',
      '首款世冠专属皮肤明日0点开售 有助力回馈福利即将开启',
      '迎王者荣耀世界冠军杯 参与活动赢惊喜好礼',
      '稷下精彩活动明日到来 任你徜徉王者峡谷',
      '稷下星之队集结 新版本超值福利回馈',
      '王者荣耀世界冠军杯荣耀来袭，KPL赛区选拔赛谁能突围而出？',
      'KCC小组赛快讯：毫无悬念，RW侠稳定发挥零封KZ',
      '世冠课代表：小组赛第五日比赛',
      '你是赛评师：eStarPro强势零封RNG.M，他们是世冠最强战队吗？',
      'KCC小组赛快讯：势如破竹 eStar零封RNG.M展现世冠最高战力'
    ]
